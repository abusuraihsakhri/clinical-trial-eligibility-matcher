"""
FastAPI REST API Server for Clinical Trial Eligibility Matcher.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "clinical-trial-eligibility-matcher", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
